              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Grupo <button class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 700px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-ms-6 col-xs-12">
                            ...
                            <input type="text" onkeyup="mayus(this);" class="form-control" name="CodGrupo" id="CodGrupo" maxlength="45" placeholder="Codigo" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-ms-6 col-xs-12">
                             <label>Nombre</label>
                            <input type="text" onkeyup="mayus(this);" class="form-control" name="NombreGrupo" id="NombreGrupo"  maxlength="45" placeholder="Nombre" required>
                          </div>
