                    ...
                    <div class="panel-body" style="height: 700px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-ms-6 col-xs-12">
                            ...
                            <input type="text" onkeyup="mayus(this);" class="form-control" name="CodCategoria" id="CodCategoria" maxlength="45" placeholder="Codigo" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-ms-6 col-xs-12">
                             <label>Nombre</label>
                            <input type="text" onkeyup="mayus(this);" class="form-control" name="NombreCategoria" id="NombreCategoria"  maxlength="45" placeholder="Nombre" required>
                          </div>
